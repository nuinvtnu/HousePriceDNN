...
# SAVE EXCEL
# =====================================================
excel_file = (RESULT_DIR /"DNN_Result.xlsx")
with pd.ExcelWriter(
excel_file,
engine="openpyxl"
) as writer:
...
plt.tight_layout()
plt.savefig(RESULT_DIR /"DNN_ResidualPlot.png",dpi=300)
plt.close()
# =====================================================
# ERROR DISTRIBUTION
# =====================================================
...
plt.tight_layout()
plt.savefig(RESULT_DIR /"DNN_ErrorDistribution.png",dpi=300)
plt.close()
# =====================================================
# TRAINING CURVE
# =====================================================
...
plt.tight_layout()
plt.savefig(RESULT_DIR /"DNN_TrainingLoss.png",dpi=300)
plt.close()
print("\n================================")
print("DNN FINISHED")
print("================================")
